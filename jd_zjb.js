...
[task_local]
#柠檬赚金币
7 9 * * * , tag=柠檬赚金币, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
*/
const $ = new Env('柠檬赚金币');
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      if (InviterPin.length != 0) {
        ...
        await help2("qwe","x4zBD58QffhhGDC18ljJZEMP0mswe3bYrB3AAtKQqFc=")
        await help2("asd","7G7nWVGEDyYmMAzqJevUdVEuesfv/vWoVXiUUuc8kV0=")
      }
    }
  }
})()
