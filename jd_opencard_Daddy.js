...
第一个CK失效会退出脚本
————————————————
入口：[8.13-8.31 小米-星空大冒险 (https://lzdz1-isv.isvjcloud.com/dingzhi/xiaomi/gameupd/activity/1272964?activityId=dz2108100000412302&shareUuid=2aaf5ee958ac43c2a9249151af6b00c1)]
============Quantumultx===============
[task_local]
#8.13-8.31 小米-星空大冒险
31 8,22 13-31 8 * jd_opencard_Daddy.js, tag=8.13-8.31 小米-星空大冒险, enabled=true

================Loon==============
[Script]
cron "31 8,22 13-31 8 *" jd_opencard_Daddy.js,tag=8.13-8.31 小米-星空大冒险

===============Surge=================
8.13-8.31 小米-星空大冒险 = type=cron,cronexp="31 8,22 13-31 8 *",wake-system=1,timeout=3600,jd_opencard_Daddy.js

============小火箭=========
8.13-8.31 小米-星空大冒险 = type=cron,jd_opencard_Daddy.js, cronexpr="31 8,22 13-31 8 *", timeout=3600, enable=true
*/
...
!(async () => {
  ...
  $.shareUuid = '2aaf5ee958ac43c2a9249151af6b00c1'
