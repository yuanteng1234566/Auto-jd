...
===============小火箭==========
京喜领88元红包 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jxlhb.js, cronexpr="4 2,10,22 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  if (!res) {
    ...
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/jxhb.json')
  }
