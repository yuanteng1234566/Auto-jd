/*
618动物联萌
解密参考自：https://raw.githubusercontent.com/asd920/Auto-jd/main/jd_zoo.js
===================quantumultx================
[task_local]
#618动物联萌
36 0,6-23/2 * * * https://raw.githubusercontent.com/asd920/Auto-jd/main/jd_zoo.js, tag=618动物联萌, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "36 0,6-23/2 * * *" script-path=https://raw.githubusercontent.com/asd920/Auto-jd/main/jd_zoo.js, tag=618动物联萌
...
!(async () => {
    ...
    let res = [], res2 = [], res3 = [];
    //res = await getAuthorShareCode('https://raw.githubusercontent.com/asd920/updateTeam/main/shareCodes/jd_zoo.json');
    res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/jd_zoo.json');
    res3 = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/asd920/updateTeam/main/shareCodes/jd_zoo.json');
    if (pKHelpAuthorFlag) {
